...
| Muted text | `#475569` | `--muted-foreground` |
| CTA/Urgent | `#f97316` | `--cta` |
| Success | `#16a34a` | `--success` |
| Border | `#e2e8f0` | `--border` |

**Color Notes:** Light refined canvas — teal accent, orange for pending/urgent actions only
